...
public enum CachedMovieMapper {
    public static func toEntity(_ movie: IngressoMovie) -> CachedMovieEntity {
        CachedMovieEntity(
            movieId: movie.id,
            title: movie.title,
    ...
    public static func toDomain(_ entity: CachedMovieEntity) -> IngressoMovie {
